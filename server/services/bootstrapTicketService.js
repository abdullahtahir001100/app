...
function buildBashInstallScript(ticket, platform = 'mac') {
    ...
    return [
        ...
        'if [ "$OS" = "mac" ]; then',
        '  rm -rf "$HOME/Applications/ZenvoraAgent.app" 2>/dev/null || true',
        '  APP_DIR="$HOME/Library/Application Support/Zenvora/ZenvoraAgent.app"',
        ...
        '    <key>CFBundleName</key><string>ZenvoraAgent</string>',
